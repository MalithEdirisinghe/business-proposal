...
//         setMissingInfo(result);  // Store the response to display in the modal
...
//         <div className="modal-overlay" onClick={() => setShowMissingInfoModal(false)}>
//           <div className="modal-content1" onClick={(e) => e.stopPropagation()}>
//             <h2>{content.missingDetailsHeading}</h2>
//             <p>
//               {language === "Sinhala"
//                 ? "වැදගත් විස්තර අඩුයි, එය ඔබගේ ව්‍යාපාර යෝජනාවේ ගුණාත්මකභාවය සහ කාර්යක්ෂමතාව වැඩි දියුණු කිරීමට උපකාරී විය හැක."
//                 : "Some important details are missing, which could enhance the quality and effectiveness of your business proposal."}
//             </p>
//             <ul>
//               {missingInfo?.missing_topics?.map((topic, index) => (
//                 <li key={index}>
//                   {content.missingInfo[topic] || topic}
//                 </li>
//               ))}
//             </ul>
