...
//   const { headings } = location.state || { headings: [] }; // Get headings from state or default to an empty array
...
//           <div key={index} className="content-item">
//             <span className={`dot ${index % 4 === 0 ? "yellow" : index % 4 === 1 ? "green" : index % 4 === 2 ? "blue" : "red"}`}></span>
//             <div>
